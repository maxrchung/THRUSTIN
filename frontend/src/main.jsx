...
class Client extends React.Component {
  ...
  handleClose = () => {
    this.setMessage(
      "Yo the connection broke so that probably means you were inactive too long or the server blew up. Try refreshing maybe."
    );
  };

  handleKeyDown = (e) => {
    const isWhitedModifier =
  ...
  renderTop() {
    ...
    return (
      <Message>
        <h1 className="mb-0">
          <img alt="THRUSTIN" src="favicon-96.png" />
        </h1>
      </Message>
    );
  }
    ...
    return (
      <Container fluid>
        ...
        <CommandBar
          ...
          ref={(commandBar) => {
            if (commandBar) this.typeahead = commandBar.typeahead;
          }}
