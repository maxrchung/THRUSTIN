...
impl Default for Deck {
    fn default() -> Deck {
        ...
        let thrustees = vec![
            ...
            r#"<br/>&nbsp;○&nbsp;&nbsp;&nbsp;●&nbsp;<br/>/|\&nbsp;/|\<br/>/&nbsp;\&nbsp;/&nbsp;\<br/>&nbsp;_____"#,
            "I have recurring nightmares. Every night I dream horrible things about _____.",
            "If you get a point for this THRUST you literally just win the game. THRUSTIN the video game you literally completely 100% just win it. You actually literally just win at life. Like literally, figuratively you are absolutely, without a doubt the greatest human being in the entire world. _____.",
            "If you get a point for this THRUST you literally just lost the game. THRUSTIN the video game you literally completely 100% just lost it. You actually literally just lose at life. Like literally, figuratively you are absolutely, without a doubt the worst human being in the entire world. _____.",
            "Yo, what the hell was that just now? Did you hear that? Holy shit, it’s _____.",
            "It’s genie time, baby. Wishes give ‘em?<br/>1). _____.<br/>2). _____.<br/>3). _____.",
            "Flipping to a random page in the dictionary and finding _____.",
            "Why _____?",
            "Why not _____?",
            "If there was ever a time to _____, it’s now.",
            "I’ll trade you _____ for _____.",
            "<br/>Man and Woman walk down the street.<br/>Second Man approaches Man and Woman.<br/>Second Man raises a gun to Man and Woman.<br/>Second Man threatens, “Give me your money if you want to die.”<br/>Man says, “Okay.”<br/>Man gives Second Man his wallet.<br/>Second Man says, “Thanks.”<br/>Second Man shoots Man in the chest.<br/>Man falls over into Woman’s arms.<br/>Woman cries.<br/>Man is in pain.<br/>Man turns to woman and says in dying breath, “_____.”",
            "In the beginning, there was _____. Then, there was _____.",
            "Nobody would be stupid enough to believe _____ unless if you’re _____.",
            ...
            "Kenny is misunderstood. He’s not the type of person that would _____.",
            "Please man, I’ll give you all my money. I’ll give you everything I have. Just don’t _____.",
            "What to say to innocent young children to make them realize the harsh realities of the world: _____.",
            "Welp, we’ve come so far already, might as well finish the job. There’s only _____ left to do.",
            "Is _____ a crime?",
            "<br/>Knock knock.<br/>Who’s there?<br/>_____.<br/>_____ who?<br/>_____ _____."
        ];
        Deck {
