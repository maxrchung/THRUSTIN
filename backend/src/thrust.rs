...
impl Default for Deck {
    fn default() -> Deck {
        let thrusters = vec![
			...
			"choking a new top play, getting visibly upset, and throwing your XP-Pen G640 only to get a new one next week",
        ...
        let thrustees = vec![
			...
			"The look normies give me after _____ sends me into a fit of rage before sending me into a downward-spiral of _____.",
			...
			"_____ is my worst enemy. I would quit my job, sell my house, leave my wife and children just to track it down just to eliminate it.",
			...
			"I bet you think you’re so fucking cool. Just waiting until _____ comes. Then I’ll be the one laughing.",
			...
			"I find _____ sexually attractive.",
