...
fn endless_configurations() {
    ...
    client.send(1, ".i");
    client.read_all();
    assert_eq!(client.last(1), "\\\\Lobby info//<br/>Name: 0<br/>Chief: EndlessLobbyHostDoggo<br/>Players: 1/18446744073709551615<br/>Max points? 255<br/>House THRUSTS? 18446744073709551615<br/>THRUSTEES? 3<br/>THRUSTERS? 5");
}
