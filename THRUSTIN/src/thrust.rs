...
impl Default for Deck { 
	fn default() -> Deck {
		...
		"Good Vibes".to_string(),
		 ...
		 "They should really bring back _____, I missed it when it was banned in 2020.".to_string(), "Do you ever wake up and _____?".to_string(), "I sit and ponder why _____.".to_string(),
