...
impl Default for Deck {
    fn default() -> Deck {
        Deck{thrusters: vec!["Kenny".to_string(), 
        "Brenn".to_string(), 
        "Jimmy".to_string(), 
        "Max".to_string(), 
        "Royce".to_string(), 
        "Alex".to_string(), 
        "homosexuality".to_string(), 
        "heterosexuality".to_string(),
		"Gmaul".to_string(), 
        "Runescape".to_string(), 
        "dick".to_string(), 
        "big juicy cock".to_string(), 
        "osu!".to_string(), 
        "peppy points".to_string(), 
        "black people".to_string(), 
        "tablet pen".to_string(),
		"ass fucking".to_string(), 
        "Omega Sector".to_string(), 
        "rape and pillage".to_string(), 
        "tribal slaughter".to_string(), 
        "cat ears".to_string(), 
        "degeneracy".to_string(), 
        "anime".to_string(),
		"hentai".to_string(), 
        "big anime titty".to_string(), 
        "gaming".to_string(), 
        "3/5ths Compromise".to_string(), 
        "cotton fields".to_string(), 
        "slavery".to_string(), 
        "furry".to_string(),
		"99 pure str".to_string(), 
        "full combo".to_string(), 
        "niseboi".to_string(), 
        "Kenny getting fucked in the ass".to_string(), 
        "racism".to_string(), 
        "Riku".to_string(), 
        "Rust".to_string(),
		"Rustacean".to_string(), 
        ...
        "sucking dick at osu!".to_string(), 
        "Jews".to_string(), 
        "Minecraft".to_string(),
		"hot anime sex".to_string(), 
        "lolicon".to_string(), 
        "swag42069".to_string(), 
        "rock hard dick".to_string(), 
        "anal sex while playing osu!".to_string(), 
        "cheesy dick".to_string(),
		"Dream Solister".to_string(), 
        "osu! UCI".to_string(), 
        "McDonalds".to_string(), 
        "Burger King".to_string(), 
        "McSad".to_string(), 
        "Pippins".to_string(), 
        "bro I wanna really die".to_string(), 
        "moist".to_string(), 
		"while still in my panties, I vomited from my jowls a chunky curd of phlegm".to_string(), 
        "pulsating purple cock".to_string(), 
        "gurgling a moist egg yolk while I blogged about it".to_string(), 
        "thanks for the protein".to_string(),
		"keep my cock in your mouth until we get home".to_string(), 
        "he told me that you were going to adore and cherish this big black cock".to_string(), 
        "cum box".to_string(), 
        "I'm harder than steel".to_string(),
		"I'm being raped by a monster".to_string(), 
        "eating cum from my ass".to_string(), 
        "BDSM".to_string(), 
        "the salty drips of precum that are rubbed over my tongue".to_string(), 
        "I roll my hips, his slick, hot crown, teasing at my star, until finally I feel it loosen enough".to_string(),
		"naked woman".to_string(), 
        "young boy".to_string(), 
        "aborted fetus".to_string(), 
        "fucking a pregnant woman and her fetus at the same time".to_string(), 
        "The Boy in the Mirror".to_string(), 
        "getting a tablet pen stick in my dick".to_string(),
		"wiring up my dick to work as a tablet pen".to_string(), 
        "a fast forward/backward movement of the hips, usually in sexual activity".to_string(), 
        "when a guy goes in and out of a girl's vagina really fast getting ready to cum kind of like humping".to_string(),
		...
		"trust, the hardest thing to gain and the easiest thing to lose".to_string(), 
        "I actually want to die".to_string(), "I'm going to fucking kill you".to_string(), 
        "shitting in a girl's vagina and fucking it".to_string(),
		"digging up a mostly rotted corpse, hook it up with wires that connect to a source of electricity, puppeteer it and have people pay to have sex with it".to_string(), 
        "gayme jam".to_string(), 
        "who wrote these".to_string(), 
        "I gurgled a moist egg yolk and vomited from my jowls a chunky curd of phlegm that was dripping with roaches, maggots and mucus.".to_string(),
		"Slackjaws drooling on my dick".to_string(), "jacking off in a public restroom and accidentally cumming on the guy next to me".to_string(), 
        "secretly whacking your meat to hentai in class while the guy next to you tries to sleep".to_string(), "how old I was when my older sister made me her sex slave".to_string(),
		...
		"welcome to the jam".to_string(),
         ...
         "_____, that's what I rub my nipples out to.".to_string(),
		 "In class I always make sure to _____ the fucker sitting next to me.".to_string(), 
         "_____ really got fucked in the ass by black people.".to_string(), 
         "I really want to _____ before I die.".to_string(),
		 "There's only one more thing I like more than anime, and it's _____.".to_string(), 
         "Whenever I see _____ it reminds me of Kenny.".to_string(), "Fuck _____ I'm going to play osu! and suck my own dick.".to_string(),
		 "They should really bring back _____, I missed it when it was banned in 2020.".to_string(), 
         "Do you ever wake up and _____?".to_string(), "I sit and ponder why _____.".to_string(), 
         "Whenever I see _____ I can't help but drop my pants".to_string(), 
         "The secret to getting to best _____ is slavery".to_string(),
		 "While I was on the way to school I ran into _____ and started slamming my dick".to_string(), 
         "The only thing worse than getting caught playing osu! is _____".to_string(), 
         "The three steps to getting good at osu are:\n1. Buying a tablet\n2. Getting a good keyboard\n3. _____".to_string(),
		 "_____, the only thing better than programming in Rust".to_string(), 
         "Instead of paying for _____ I would rather slap Kenny on the ass".to_string(), 
         "I am _____ and I want to fucking die".to_string(),
